...
class HomeVC: BaseVC {
    ...
    override public func viewDidLoad() {
        ...
        let controller = SideMenuVC.instantiate(fromAppStoryboard: .postlogin)
        ...
        showViewController(viewController: ApplicationsVC.self, storyboardId: "ApplicationsVC")
...
extension HomeVC: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        switch row {
        case 0:
            // Home
            self.showViewController(viewController: ApplicationsVC.self, storyboardId: "ApplicationsVC")
        case 1:
            // Favourite
            self.showViewController(viewController: FavouriteVC.self, storyboardId: "FavouriteVC")
    ...
    func showViewController<T: UIViewController>(viewController: T.Type, storyboardId: String) -> () {
        ...
        let storyboard = UIStoryboard(name: Storyboards.postlogin.rawValue, bundle: nil)
